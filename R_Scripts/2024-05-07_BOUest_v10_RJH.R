...
saveRDS(combined.df, file = "2024-08-09_combined_env_data_hourly.rds")
...
saveRDS(combined.df.daily, file = "2024-08-09_combined_env_data_daily.rds")


# ---- nice plot of available AOU and BOU data -----

combined.df <- readRDS(file = "2024-08-09_combined_env_data_hourly.rds")
...
png("../Figures/manuscript_figures/2024-08-09_fig1.png", width = 1000, height = 500)
...
saveRDS(combined.df.select, file = "2024-08-09_combined.df.select.rds")
...
saveRDS(final.gbm, file = "2024-08-09_final_gbm.rds")

# ---- apply final model to test data ----

final.gbm <- readRDS("2024-08-09_final_gbm.rds")
...
png("../Figures/manuscript_figures/2024-08-09_fig2.png", width = 700, height = 500)

(plot.2a) / (plot.2b + plot.2c)

dev.off()

png("../Figures/manuscript_figures/2024-08-09_fig3.png", width = 1000, height = 250)
...
save(list = c('combined.gbm', 'full.gbm', 'hyper.grid'), file = '20240809_model.Rdata')



# ---- apply model to full miniDot timeseries ----

combined.df <- readRDS("2024-08-09_combined_env_data_hourly.rds")
load(file = "20240809_model.Rdata")
